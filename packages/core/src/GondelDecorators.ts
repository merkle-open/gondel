...
function hookEventDecoratorInCore() {
	addGondelPluginEventListener(
		'GondelDecorators',
		'register',
		function (component, { componentName, namespace, gondelComponentRegistry }, next) {
...
export function EventListener(eventName: string, selector?: string | object) {
	return function <T extends { __events?: Array<EventOption> } & GondelComponent>(target: T, handler: string) {
